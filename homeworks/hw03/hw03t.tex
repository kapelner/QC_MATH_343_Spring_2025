...
What is the interpretation of the $b$ for \texttt{wt.loss} (the unit of this feature is lbs)?\spc{6}


\easysubproblem{What is the interpretation of the $b$ for \texttt{ph.karno} (the unit of this feature is mg/dL) if \texttt{ph.karno} is known to be causal?}\spc{6}
...
\problem{This question is about hazard rates and Cox proportion hazard models. This will only}
