...
\date{Due noon April 11 on github\\ \vspace{0.5cm} \small (this document last updated \currenttime~on \today)}
}
...
\beqn
Y_1, Y_2, \ldots, Y_n ~|~ t_1, t_2, \ldots, t_n \inddist \poisson{\beta_0 + \beta_1 t_i}
\eeqn
...
\intermediatesubproblem{Given your answer in (a), the $\support{\beta_0}$, provide a proposal distribution  for the conditional distribution of $\beta_0$:

\beqn
q(\beta_0\,|\,y_1, \ldots, y_n, t_1, \ldots, t_n, \beta_1, \phi)= \hspace{6in}
\eeqn}

\intermediatesubproblem{Given your answer in (a), the $\support{\beta_1}$, provide a proposal distribution  for the conditional distribution of $\beta_1$:

\beqn
q(\beta_1\,|\,y_1, \ldots, y_n, t_1, \ldots, t_n, \beta_0, \phi)= \hspace{6in}
\eeqn}
