...
\subquestionwithpoints{3} After thinning, how many samples would be left in the Gibbs chains approximately? (Assume we burned a very small number of iterations).
%
\iftoggle{solutions}{\inred{
\beqn
2000
...
\subquestionwithpoints{2} Circle one: are there closed form solutions for either parameter's maximum likelihood estimate? \quad yes \quad /  \quad \iftoggle{solutions}{\inred{no}}{no}
