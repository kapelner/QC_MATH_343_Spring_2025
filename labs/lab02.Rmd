...
## Problem 5: Bayesian Inference for Poisson Time-Trend Regression using Metropolis Sampling and Stan
...
t = runif(n, 0, 10)
for (i in 1 : n){
  y[i] = rpois(n, true_beta_0 + true_beta_1 * t)
}

ggplot(data.frame(y = y, t = t)) + 
  geom_histogram(aes(x = t, y = y))
```
