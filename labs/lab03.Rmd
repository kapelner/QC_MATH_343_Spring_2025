...
We will look at a very famous dataset: the Berkeley graduate school PhD admission dataset of 1973, a dataset every student of Statistics should know about:
...
What is the name of the paradox that embodies the discrepancy between these two results above?

#TO-DO

Make up a story as to why this paradox occurs. It is pure speculation!
...
# Problem 7: Cox Proportional Hazard Models

We fit a coxPH model on the lung cancer data via the code below:
...
Interpret the exponential coefficient for the wt.loss variable.

#TO-DO

Do the three variables age, pat.karno and meal.cal jointly matter for the hazards rate? Test at alpha = 5%.
